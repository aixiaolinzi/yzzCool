...
import com.yue.opengl.deep5.filter.OesFilter;
import com.yue.opengl.deep5.utils.Gl2Utils;

import javax.microedition.khronos.egl.EGLConfig;
import javax.microedition.khronos.opengles.GL10;

import static com.yue.opengl.deepy5.CameraId.FRONT;
 ...
 * Description:
 */
public class CameraYzzDrawer implements GLSurfaceView.Renderer {
    //    private final AFilter mOesFilter;
    private final OesFilter mOesFilter;
    //相机的id
    private CameraId mCameraId = CameraId.REAR;
    //相机输出的surfaceView
    ...
    public CameraYzzDrawer(Resources res) {
