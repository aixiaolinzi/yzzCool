...
import com.yue.opengl.deep4.GLRendererTextureFilter4;
 ...
 *
 */
public class Deep5CameraActivity extends AppCompatActivity {
...
//                    FileUtils.saveFile(bitmap, fileName);
                    ...
                    runOnUiThread(() -> {
                        Deep5CameraActivity context = Deep5CameraActivity.this;
