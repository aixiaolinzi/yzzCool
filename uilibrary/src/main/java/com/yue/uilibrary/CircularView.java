...
public class CircularView extends View {
    ...
    private Path mAbovePath, mBelowWavePath;//上面的路径，下面的路径
    private Paint mAboveWavePaint, mBelowWavePaint;//上面的画笔和下面的画笔

    private DrawFilter mDrawFilter;

    private float φ;

    private OnWaveAnimationListener mWaveAnimationListener;//监听的位置
