 ...
 * Time:2021/9/13
 * Author:yzzCool
 * Description: 和 GLRenderer2_5 的代码是一样的。
 */
public class GLRenderer2_6_2 implements GLSurfaceView.Renderer {
    private Context mContext;

    Triangle2_6_2 mTriangle262;
    ...
    public GLRenderer2_6_2(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        mTriangle262 = new Triangle2_6_2(mContext);
    }
