...
import example.yzz.openglwar.adapter.ImagePagerAdapter;
...
public class ImagePagerFragment extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
    ...
    // paging the images.
    viewPager.setCurrentItem(WarEpisodeMainActivity.currentPosition);
    viewPager.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
      @Override
      public void onPageSelected(int position) {
        WarEpisodeMainActivity.currentPosition = position;
      }
    });
        ...
        new SharedElementCallback() {
          ...
          public void onMapSharedElements(List<String> names, Map<String, View> sharedElements) {
            ...
            Fragment currentFragment = (Fragment) viewPager.getAdapter()
                .instantiateItem(viewPager, WarEpisodeMainActivity.currentPosition);
