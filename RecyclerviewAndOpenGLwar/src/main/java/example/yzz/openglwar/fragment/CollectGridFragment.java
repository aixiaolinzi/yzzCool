 ...
 *  
 */
public class CollectGridFragment extends Fragment {
  ...
  private void scrollToPosition() {
    recyclerView.addOnLayoutChangeListener(new OnLayoutChangeListener() {
      ...
      public void onLayoutChange(View v,
        ...
        View viewAtPosition = layoutManager.findViewByPosition(WarEpisodeMainActivity.currentPosition);
        // Scroll to position if the view for the current position is null (not currently part of
        // layout manager children), or it's not completely visible.
        if (viewAtPosition == null || layoutManager
            .isViewPartiallyVisible(viewAtPosition, false, true)) {
          recyclerView.post(() -> layoutManager.scrollToPosition(WarEpisodeMainActivity.currentPosition));
        }
      }
    });
  }
        ...
        new SharedElementCallback() {
          ...
          public void onMapSharedElements(List<String> names, Map<String, View> sharedElements) {
            ...
            RecyclerView.ViewHolder selectedViewHolder = recyclerView
                .findViewHolderForAdapterPosition(WarEpisodeMainActivity.currentPosition);
